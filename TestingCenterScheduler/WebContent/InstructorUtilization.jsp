			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							Utilization <small>View in date range of new request</small>
						</h1>
						<ol class="breadcrumb">
							<li class="active"><a href="Instructor.jsp">Home</a> >
								Request Utilization</li>
						</ol>
					</div>
				</div>
				<div class="div-spacing">
					<div class="row">
						<div class="col-lg-12">
							<ul>
								<c:forEach items="${utilList}" var="uti">
									<li>${uti}</li>
								</c:forEach>
							</ul>
						</div>
				...
				<form class="form-inline" action="InstructorHome" method="POST">
					<c:set var="action" value="submitRequest" scope="session" />
					<a href="Requests.jsp" class="btn btn-default"
						style="background: #DDD; color: #980100;">Cancel</a> <input
						type="submit" value="Submit Request" class="btn btn-default"
